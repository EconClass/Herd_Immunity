...
class Simulation(object):
    ...
    def __init__(self, population_size, vacc_percentage, virus_name,
        ...
        self.logger = Logger('log.file')
        self.vacc_percentage = vacc_percentage
        self.dead = 0
        self.initial_infected = initial_infected
        # This next attribute will be used to keep track of all the people that catch
    ...
    def _create_population(self, initial_infected):
        ...
        while len(population) < self.population_size:
            if infected_count <  initial_infected:
                ...
                population.append(Person(self.next_person_id, True, None))
            else:
    ...
    def run(self):
        ...
        time_step_counter = 0
        population = self._create_population(self.initial_infected)
        ...
        for person in self.population:
            if person.is_alive == True:
                while interactions <= 100:
                    ...
                    if random_interation.is_alive is False or random_interation._id == person._id:
                        continue
